...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    joystick.back().and(joystick.y()).whileTrue(flywheel.sysIdDynamic(Direction.kForward));
    joystick.back().and(joystick.x()).whileTrue(flywheel.sysIdDynamic(Direction.kReverse));
    joystick.start().and(joystick.y()).whileTrue(flywheel.sysIdQuasistatic(Direction.kForward));
    joystick.start().and(joystick.x()).whileTrue(flywheel.sysIdQuasistatic(Direction.kReverse));
